...
public class ProductManagerFrame extends JFrame {
    ...
    private JPanel buildButtonPanel() {
        ...
        JButton addButton = new JButton("Add"), BorderLayout.SOUTH;
        ...
        JButton editButton = new JButton("Edit"), BorderLayout.SOUTH;
        ...
        JButton deleteButton = new JButton("Delete"), BorderLayout.SOUTH;
        ...
        JButton printButton = new JButton ("Print"), BorderLayout.SOUTH;
    ...
    private void doPrintButton() {
    	...
    	int selectedRow = productTable.getSelectedRow();
          if (selectedRow == -1) {
        	  JOptionPane.showMessageDialog(this, "No product selected to print", JOptionPane.ERROR_MESSAGE);
          } else {
    	JOptionPane.showMessageDialog(this, "Product printed");
